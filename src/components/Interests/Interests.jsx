  ...
  return (
    <section id="interests" className={styles.container}>
      ...
      <p className={styles.interestParagraph}>
        ...
        &quot;garbage&quot; lines to their opponent&apos;s board in an attempt
        to top them out. The key to victory lies in efficient piece placement
        and quick decision-making. To strive for the &quot;correct&quot; way to
        play is to utilize the 7-bag system, which guarantees that players will
        receive all seven Tetrominoes before any piece repeats, and using the
        T-piece to clear T-spins in an effort to send the most lines.
